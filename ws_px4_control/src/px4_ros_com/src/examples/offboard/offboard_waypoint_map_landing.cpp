...
//   • /desired_body_yaw_enu 구독 → ENU→NED 변환해 TrajectorySetpoint.yaw 주입  ◂ NEW
//   • 주기 20 Hz
...
#include <std_msgs/msg/float32.hpp>          // ▸ NEW : yaw 협조
    ...
    start_sub_ = create_subscription<std_msgs::msg::Int32>(
      ...
      [this](const std_msgs::msg::Int32::SharedPtr msg){
        if(msg->data==1 && !got_start_){
          got_start_=true; state_=State::INIT;
...
private:
  ...
  /* 파라미터 */
  double takeoff_alt_, approach_alt_, descent_speed_, touchdown_alt_, landing_h_thresh_;
